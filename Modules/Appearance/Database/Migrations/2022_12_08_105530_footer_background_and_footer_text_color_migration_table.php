...
class FooterBackgroundAndFooterTextColorMigrationTable extends Migration
{
    ...
    public function up()
    {
        ...
        if (Schema::hasTable('theme_colors') && Schema::hasColumn('theme_colors', 'footer_color')) {
            // DB::statement("ALTER TABLE theme_colors RENAME COLUMN footer_color TO footer_background_color;");
            // DB::statement("ALTER TABLE theme_colors ALTER COLUMN footer_background_color TYPE VARCHAR(255);");
            DB::statement('ALTER TABLE theme_colors RENAME COLUMN footer_color TO footer_background_color;');
            DB::statement("ALTER TABLE theme_colors ALTER COLUMN footer_background_color TYPE VARCHAR(255);");
