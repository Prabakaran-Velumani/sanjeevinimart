...
class ChangeColorSchemePermisionRouteName extends Migration
{
    ...
    public function up()
    {
        ...
        if(Schema::hasTable('theme_colors')){
            ...
            DB::statement("ALTER TABLE theme_colors ALTER COLUMN status SET DATA TYPE SMALLINT USING status::SMALLINT;");
            DB::statement("ALTER TABLE theme_colors ALTER COLUMN status SET DEFAULT 0;");
