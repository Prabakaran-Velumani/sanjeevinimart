...
class CreateSidebarsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('sidebars', function (Blueprint $table) {
            ...
            $table->tinyInteger('type')->nullable()->comment('1 for main menu, 2 for sub menu , 3 action');
        ...
        $sql = [
            ...
            ['sidebar_id' => 17, 'module_id' => 3, 'parent_id' => 14, 'name' => 'Header', 'route' => 'appearance.slider.index', 'type' => 2],
            ...
            ['sidebar_id' => 20, 'module_id' => 4, 'parent_id' => 19, 'name' => 'Blog Posts', 'route' => 'blog.posts.index', 'type' => 2],
