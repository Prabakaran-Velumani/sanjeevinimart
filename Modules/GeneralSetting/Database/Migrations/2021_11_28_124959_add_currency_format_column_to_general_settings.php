    ...
    public function up()
    {
        ...
        Schema::table('general_settings', function (Blueprint $table) {
            ...
            if(!Schema::hasColumn('general_settings','decimal_limit')){
                $table->integer('decimal_limit')->default(2)->after('currency_symbol_position');
            }
            if(!Schema::hasColumn('general_settings','default_country')){
                $table->bigInteger('default_country')->default(18)->nullable()->after('decimal_limit');
            }
            if(!Schema::hasColumn('general_settings','default_state')){
                $table->bigInteger('default_state')->default(348)->nullable()->after('default_country');
            }
