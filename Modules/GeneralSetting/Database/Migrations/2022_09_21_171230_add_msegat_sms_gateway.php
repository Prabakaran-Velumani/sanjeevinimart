    ...
    public function up()
    {
        ...
        if(Schema::hasTable('general_settings')){
            ...
            Schema::table('general_settings', function (Blueprint $table) {
                ...
                $table->string('preloader_image', 255)->nullable()->change();
            });
        }
        if(Schema::hasTable('holidays')){
            // DB::statement("ALTER TABLE holidays CHANGE date date VARCHAR(255) NOT NULL;");
            DB::statement("ALTER TABLE holidays ALTER COLUMN date TYPE VARCHAR(255);");
            DB::statement("ALTER TABLE holidays ALTER COLUMN date SET NOT NULL;");
        }
