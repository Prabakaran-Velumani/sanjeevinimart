    ...
    public function up()
    {
        if(Schema::hasTable('general_settings')){
            Schema::table('general_settings', function (Blueprint $table) {
                ...
                // $table->integer('preloader_style')->default(0)->after('preloader_status');
                // $table->string('preloader_image')->nullable()->after('preloader_style');

                $table->unsignedTinyInteger('preloader_type')->default(1)->nullable();
                $table->boolean('preloader_status')->default(1);
                $table->integer('preloader_style')->default(0);
