...
class CreateChartOfAccountsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('chart_of_accounts', function (Blueprint $table) {
            ...
            $table->bigInteger("morphable_id")->nullable();
        ...
        $sql = [
            ['code' => 'income-1','type' => 'Income','default_for' => 'Income', 'name' => 'Main Income', 'opening_balance' => 0, 'description' => 'this is for main income from system', 'created_by' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'income-2','type' => 'Income','default_for' => 'Seller Account', 'name' => 'Main Seller Account', 'opening_balance' => 0, 'description' => 'This is for seller account', 'created_by' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'Income-3','type' => 'Income','default_for' => 'Product Wise Tax Account', 'name' => 'Product TAX', 'opening_balance' => 0, 'description' => 'This is for product tax', 'created_by' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'liability-1','type' => 'Liability','default_for' => 'GST Tax Account', 'name' => 'GST TAX', 'opening_balance' => 0, 'description' => 'This is for GST', 'created_by' => 1, 'created_at' => now(), 'updated_at' => now()],
        ];
        // $sql = [
        ...
        DB::table('chart_of_accounts')->insertOrIgnore($sql);
    }
