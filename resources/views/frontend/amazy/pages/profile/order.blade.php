                                                                        ...
                                                                        <a href="{{singleProductURL(@$package_product->seller_product_sku->product->seller->slug, @$package_product->seller_product_sku->product->slug)}}" class="d-flex align-items-center gap_20 cart_thumb_div">
                                                                            <div class="thumb">
                                                                                @if (@$package_product->seller_product_sku->sku->product->product_type == 1)
                                                                                    <img src="{{showImage(@$package_product->seller_product_sku->product->thumbnail_image_source??@$package_product->seller_product_sku->sku->product->thumbnail_image_source)}}" alt="@if (@$package_product->seller_product_sku->product->product_name) {{textLimit(@$package_product->seller_product_sku->product->product_name,22)}} @else {{textLimit(@$package_product->seller_product_sku->sku->product->product_name,22)}} @endif" title="@if (@$package_product->seller_product_sku->product->product_name) {{textLimit(@$package_product->seller_product_sku->product->product_name,22)}} @else {{textLimit(@$package_product->seller_product_sku->sku->product->product_name,22)}} @endif">
                                                                                @else
                                                    ...
                                                    @foreach ($order_package->products as $key => $package_product)
                                                        ...
                                                        @else
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td>
                                                                    <h4 class="font_16_top f_w_500 m-0 ">{{__('common.qty') }}: {{ getNumberTranslate($package_product->qty) }}y46hu</h4>
                                                                </td>
                                                                <td>
                                                                    <h4 class="font_16 f_w_500 m-0 ">{{ single_price($package_product->price) }}</h4>
                                                                </td>
